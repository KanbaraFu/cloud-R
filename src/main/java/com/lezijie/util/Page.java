...
@Data
public class Page<T> {
    private Integer pageNum; // 当前页（如果前台为传递，则默认第一页）
    ...
    private Integer startNavPage; // 导航开始页 （当前页-5小于1，则导航开始页为1，此时导航结束页为导航开始数+9；如果导航开始数+9，则导航结束页为总页数）
    ...
    public Page(Integer pageNum, Integer pageSize, long totalCount) {
        ...
        // 导航开始页 （当前页-5小于1，则导航开始页为1，此时导航结束页为导航开始数+9；如果导航开始数+9大于总页数，则导航结束页为总页数）

        if (this.startNavPage < 1) {
            // 当前页-5小于1，则导航开始页为1
            this.startNavPage = 1;
            // 导航结束页尾导航开始数+9；如果导航开始数+9大于总页数，则导航结束页为总页数
